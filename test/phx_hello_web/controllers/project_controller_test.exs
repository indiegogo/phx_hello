defmodule PhxHelloWeb.ProjectControllerTest do
  ...
  describe "update project" do
    ...
    test "redirects when data is valid", %{conn: conn, project: project} do
      ...
      assert html_response(conn, 200) =~ "some updated story"
    end
